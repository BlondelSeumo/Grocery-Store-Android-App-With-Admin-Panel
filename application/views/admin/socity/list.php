                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="socity_name" class="form-control" placeholder="Socity Name"/>
                                        </div>
                                        <div class="form-group">
                                            <label class=""><?php echo $this->lang->line("Pincode / Area code :");?> <span class="text-danger">*</span> 
                                            <input type="text" name="pincode" class="form-control" placeholder="123456"/>
                                        </div>
                                         <div class="form-group">
                                    ...
                                    <div class="box-footer">
                                        <input type="submit" class="btn btn-primary" name="addcatg" value="Add Society" />
                                           ...
                                           <?php foreach($socities as $socity){ ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><div class="btn-group">
                                                        ...
                                                        <?php echo anchor('admin/delete_socity/'.$socity->socity_id, '<i class="fa fa-times"></i>', array("class"=>"btn btn-danger", "onclick"=>"return confirm('Are you sure delete?')")); ?>
