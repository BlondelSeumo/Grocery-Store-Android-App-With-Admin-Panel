                        ...
                        <div class="col-xs-6">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title"><?php echo $this->lang->line("Edit Socity");?></h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label class=""><?php echo $this->lang->line("Pincode / Area code :");?> <span class="text-danger"><?php echo $this->lang->line("*");?></span> 
                                            <input type="text" name="pincode"  value="<?php echo $socity->pincode; ?>" class="form-control" placeholder="123456"/>
                                        </div>
                                         <div class="form-group">
                                            <label class=""><?php echo $this->lang->line("Delivery Charge");?> : <span class="text-danger">*</span> </label>
                                            <input type="number" name="delivery" value="<?php echo $socity->delivery_charge; ?>" class="form-control" placeholder="00"/>
                                        </div>
                                    </div><!-- /.box-body -->

                                    <div class="box-footer">
                                        <input type="submit" class="btn btn-primary" name="addcatg" value="Update Society" />
