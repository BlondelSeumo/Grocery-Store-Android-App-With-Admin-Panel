                ...
                <!-- Content Header (Page header) -->
                 <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#"><?php echo $this->lang->line("Stock");?></a></li>
                        <li class="active"><?php echo $this->lang->line("All");?> </li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title"><?php echo $this->lang->line("Stock");?> <?php echo $this->lang->line("All Products");?></h3>
